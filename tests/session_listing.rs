...
fn session_list_ids_are_sorted_and_ignore_directories_without_meta() {
    ...
    fs::write(
        ...
        r#"{"session_id":"b-session","created_at":"2024-01-01T00:00:00Z","updated_at":"2024-01-01T00:00:00Z","stopped_at":null,"revision":1,"char_count":0,"agent_name":null,"model":null,"initial_role":null,"cwd":null,"effort":null}"#,
    )
    .expect("write meta");
    ...
    fs::write(
        ...
        r#"{"session_id":"a-session","created_at":"2024-01-01T00:00:00Z","updated_at":"2024-01-01T00:00:00Z","stopped_at":null,"revision":1,"char_count":0,"agent_name":null,"model":null,"initial_role":null,"cwd":null,"effort":null}"#,
    )
    .expect("write meta");
